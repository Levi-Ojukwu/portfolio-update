...
const AboutSection: React.FC = () => {
  ...
  const personalInfo: PersonalInfo[] = [
    { label: "Website", value: "www.dormain.com" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              {personalInfo.map((info, index) => (
                <div key={index} className="border-b border-border py-3">
                  <p className="font-semibold">
                    {info.label}: <span className="font-normal text-muted-foreground">{info.value}</span>
                  </p>
                </div>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-semibold mb-4 font-heading">My Skills</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16">
          ...
          >
            <h3 className="text-2xl font-semibold mb-6 font-heading">Professional Skills</h3>
          ...
          >
            <h3 className="text-2xl font-semibold mb-6 font-heading">Experience</h3>
